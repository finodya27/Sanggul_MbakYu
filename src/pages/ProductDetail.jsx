      ...
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-xl p-8 md:p-12 flex flex-col md:flex-row gap-8 lg:gap-12 border border-amber-100">
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              href={`https://wa.me/6281234567890?text=Halo%2C%20saya%20tertarik%20dengan%20produk%20${encodeURIComponent(product.name)}%20(${product.id}).%20Bisakah%20Anda%20memberikan%20informasi%20lebih%20lanjut%3F`}
              target="_blank"
